# import-attribution Specification

## Purpose

Define que el registro de un import responda también a *quién* lo ejecutó, no solo a qué, cuándo y con qué resultado, y que los batches anteriores a esa trazabilidad sigan siendo consultables.
