# import-report-contract Specification

## Purpose

Define qué garantiza el reporte que devuelve un import sobre la identidad de cada fila conflictiva,
de modo que «la fila no traía este dato» y «el backend no envió el dato» sean distinguibles desde la
pantalla en vez de confundirse en una misma celda vacía.
